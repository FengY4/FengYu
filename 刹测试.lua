...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『殺脚本』"; Text ="核对用户ID中♧"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『殺脚本』"; Text ="用户ID核对完毕♣"; Duration = 4; })
